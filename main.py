...
print(data_slice[1] , data_slice[0], data_slice[3], data_slice[2])
...
testImage = "test/Phuong_Ly_99.jpg"
...
while (True):
    ...
    if ret == True:
        ...
        if cv2.waitKey(1) & 0xFF == ord('c'):
            cv2.imwrite(target_names[testImagePredict[0]] + "_DuDoan_" + str(count) + ".jpg", frame)
            count += 1
